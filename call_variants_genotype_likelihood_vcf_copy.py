...
for pileupColumn in pileupColumns:
    ...
    if rawDepth >= minTotalDepth:
        ...
        if alternative['isRelevant']:
            ...
            if(position['pos'] == 10029 - 1):
                # print(position['alleleErrorProbabilities']['A'].prod())
                # print(position['alleleErrorProbabilities']['T'].prod())
                # print(position['alleleErrorProbabilities']['C'].prod())
                # print(position['alleleErrorProbabilities']['G'].prod())

                # print(position['alleleErrorProbabilities']['C'])
                # print(position['alleleBaseQualities']['C'])
                

                print(position['alleleErrorProbabilities']['T'])
                print(position['alleleErrorProbabilities']['C'])
                print(position['alleleFrequency'])
